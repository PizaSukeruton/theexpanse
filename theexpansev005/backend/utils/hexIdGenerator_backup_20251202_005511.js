...
const HEX_RANGES = {
  vocabulary_usage_id: { start: 0xAF0000, end: 0xAF0FFF },
    ...
    // --- NEWLY ADDED RANGES FOR TEACHER/STUDENT ---
    learning_vocabulary_id: { start: 0x560000, end: 0x56FFFF },
    vocabulary_usage_id: { start: 0x570000, end: 0x57FFFF },
...
async function generateHexId(idType) {
    ...
    try {
        ...
        if (result.rows.length === 0) {
            ...
            currentCounterValue = parseInt(result.rows[0].current_value, 16) + 1;
