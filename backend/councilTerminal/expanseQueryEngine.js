...
import mapsService from './tmMapsService.js';import pkg from 'pg';
const { Pool  } = pkg;
...
import { createCsvDataSource  } from './csvDataSource';
  ...
  if (destination) {
    ...
    if (nextFlightToDest) {
      ...
      return { type: "flight_info", text: `No upcoming flights to ${destination} found.` };
            ...
            if (!flight_number && !confirmation) {
              ...
              if (nextFlight) {
                ...
                if (query_type === 'status') {
                  import flightService from './tmFlightService.js';
        ...
        case "create_event": {
          import EventConversation from '../plugins/eventScheduler/eventConversation.js';
          import NaturalLanguageEventCreator from '../plugins/eventScheduler/naturalLanguageEventCreator.js';
