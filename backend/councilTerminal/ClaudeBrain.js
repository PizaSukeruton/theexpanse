...
class ClaudeBrain {
  ...
  async processQuery(command, session, user) {
    ...
    try {
      ...
      const positiveKeywords = /\b(happy|excited|great|wonderful|amazing|fantastic|thrilled|joyful|elated|grateful|blessed|awesome|ecstatic|overjoyed|good|glad|love|proud|relieved|cheerful|delighted|content)\b/i;
          ...
          try {
            ...
            switch (subtype) {
              case 'IDENTITY':
                ...
                response = identitySummary.whoIAm[0] || "I am Claude the Tanuki.";
                break;
                
              case 'CAPABILITY':
                anchorTypeUsed = 'role';
                response = identitySummary.whatIDo[0] || "I bridge human curiosity and spirit realm wisdom.";
                break;
                
              case 'RULES':
                anchorTypeUsed = 'constraint';
                response = identitySummary.whatIDoNot[0] || "My powers serve playfulness, never malice.";
                break;
              ...
              case 'NATURE':
                ...
                response = natureAnchor || identitySummary.whoIAm[1] || "I am a bake-danuki — a yokai known for transformation and playful mischief.";
                break;
              ...
              case 'DEEPER':
                ...
                const core = identitySummary.whoIAm[0] || "";
                const constraint = identitySummary.whatIDoNot[0] || "";
