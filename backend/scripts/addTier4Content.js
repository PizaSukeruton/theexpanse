...
async function addTier4Content() {
  ...
  try {
    ...
    // Refined Tanuki folklore utterances - subtle, mystical, natural
    const tanukiUtterances = [
      ...
      // OWN_COMMUNICATION_MANAGEMENT (3)
      ...
      // PARTNER_COMMUNICATION_MANAGEMENT (4)
      ...
      // SOCIAL_OBLIGATIONS_MANAGEMENT (6)
    ...
    for (const u of tanukiUtterances) {
      ...
      await client.query(
        ...
        [exampleId, claudeCharacterId, u.text, u.fn, u.sa,
         u.p, u.a, u.d, 'tier4_tanuki_folklore', true, 1, 0.95, createdBy]
      );
    ...
    console.log(`\n=== TIER 4 COMPLETE ===`);
    console.log(`Added: ${totalCount} refined Tanuki-flavoured utterances across existing functions`);
