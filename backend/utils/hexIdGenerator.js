...
const HEX_RANGES = {
    ...
    omiyage_event_id: { start: 0xB20000, end: 0xB2FFFF },
    gallery_entry_id: { start: 0xCA0000, end: 0xCAFFFF },
    ...
    tse_storytelling_performance: { start: 0xD10000, end: 0xD1FFFF },
    database_table_concept: { start: 0xDB0000, end: 0xDB7FFF },
    dossier_id: { start: 0xDB8000, end: 0xDBFFFF },
    cotw_user_language_id: { start: 0xE30000, end: 0xE3FFFF },
    cotw_language_report_id: { start: 0xE40000, end: 0xE4FFFF },
    ltlm_training_example_id: { start: 0xDC0000, end: 0xDCFFFF },
    ltlm_outcome_intent_id: { start: 0xDD0000, end: 0xDDFFFF },
    dialogue_function_id: { start: 0x340000, end: 0x340FFF },
    speech_act_category_id: { start: 0x341000, end: 0x341FFF },
    narrative_function_id: { start: 0x342000, end: 0x342FFF },
    outcome_intent_id: { start: 0x343000, end: 0x343FFF },
    emotion_register_id: { start: 0x344000, end: 0x344FFF },
    narrative_arc_id: { start: 0xDE0000, end: 0xDEFFFF },
    narrative_beat_id: { start: 0xDF0000, end: 0xDFFFFF },
    narrative_beat_transition_id: { start: 0xE00000, end: 0xE0FFFF },
    ...
    intention_id: { start: 0xBF0000, end: 0xBFFFFF },
};
