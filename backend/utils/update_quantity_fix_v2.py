...
# Use triple quotes with r prefix for the replacement to avoid escape issues
new_function = r'''def find_meaningful_quantities(doc):
...
# Replace the function (escape the backslashes in the regex)
new_function_escaped = new_function.replace('\\', '\\\\')
