import intents from './tmIntentMatcher.js';
import NextStepLogicFilter from './tmNextStepLogic.js';
const nextStepFilter = new NextStepLogicFilter();
import aiEngine from './tmAiEngine.js';
...
export default new; TmMessageProcessor();
