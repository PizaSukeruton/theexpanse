...
class CMSSocketHandler {
    ...
    sendCommand() {
        ...
        this.appendMessage('<div class="loading">Processing command...</div>');
    }
    ...
    handleCommandResponse(response) {
        ...
        // Don't clear - keeping conversation history
    ...
    appendMessage(content) {
        ...
        this.outputDisplay.appendChild(messageDiv);
    ...
    showOmiyageOffer(data) {
        ...
        this.appendMessage(`<div class="terminal-output">${content}</div>`);
    }
    ...
    acceptOmiyage(choiceId, chosenNumber) {
        ...
        this.appendMessage('<div class="loading">Claude is preparing your gift...</div>');
    }
