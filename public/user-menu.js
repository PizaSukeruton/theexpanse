function initUserPanel() {
  ...
  console.log("initUserPanel called, currentUser:", currentUser);
...
function buildUserMenu() {
  ...
  const menuItems = [
    ...
    {
      title: 'LEARNING',
      items: ['My Progress', 'Knowledge Base', 'Lessons']
    },
    {
      title: 'CHARACTERS',
    ...
    {
      title: 'ACHIEVEMENTS',
      items: ['Badges', 'Progress Tracker', 'Statistics']
    },
    {
      title: 'ACCOUNT',
...
function handleUserMenuClick(item) {
  ...
  // TBD - different handlers for each menu item
}
