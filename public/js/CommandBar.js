...
/* Tanuki Mode indicator */
document.addEventListener("DOMContentLoaded", () => {
  const indicator = document.getElementById("tanuki-indicator");
  if (!indicator) return;
  window.addEventListener("tanuki-ui-activate", e => {
      if (e.detail.active) indicator.classList.add("active");
