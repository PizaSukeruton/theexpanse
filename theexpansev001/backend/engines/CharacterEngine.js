...
// Core Character Engine - Production Grade
...
class CharacterEngine extends EventEmitter {
    ...
    async loadCharacter() {
        ...
        try {
            ...
            // Load character metadata with row lock
            const characterQuery = `
                SELECT character_id, name, description, character_type, 
            ...
            // Load all 370 slots with improved query
            const slotsQuery = `
                SELECT 
            ...
            // Normalize and categorize slots
            ...
            const inventoryResult = await client.query(inventoryQuery, [this.characterId]);
            ...
            const knowledgeResult = await client.query(knowledgeQuery, [this.characterId]);
            ...
            this.context.logger.info(`[CharacterEngine] Loaded ${this.characterId}:`, {
