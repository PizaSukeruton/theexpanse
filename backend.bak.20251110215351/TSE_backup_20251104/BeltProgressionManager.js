...
const BELT_REQUIREMENTS = {
  white_belt: {
    ...
    stripe_1: { cycles: 25, effectiveness: 0.30, efficiency: 0.25, cultural: 0.90 },
    stripe_2: { cycles: 50, effectiveness: 0.35, efficiency: 0.30, cultural: 0.92 },
    stripe_3: { cycles: 75, effectiveness: 0.40, efficiency: 0.35, cultural: 0.94 },
    stripe_4: { cycles: 100, effectiveness: 0.45, efficiency: 0.40, cultural: 0.95 }
  },
  blue_belt: {
    stripe_0: { cycles: 150, effectiveness: 0.50, efficiency: 0.45, cultural: 0.95 },
    stripe_1: { cycles: 250, effectiveness: 0.55, efficiency: 0.50, cultural: 0.95 },
    stripe_2: { cycles: 350, effectiveness: 0.60, efficiency: 0.55, cultural: 0.95 },
    stripe_3: { cycles: 450, effectiveness: 0.65, efficiency: 0.60, cultural: 0.95 },
    stripe_4: { cycles: 550, effectiveness: 0.70, efficiency: 0.65, cultural: 0.95 }
  },
  purple_belt: {
    stripe_0: { cycles: 700, effectiveness: 0.72, efficiency: 0.67, cultural: 0.96 },
    stripe_1: { cycles: 900, effectiveness: 0.74, efficiency: 0.69, cultural: 0.96 },
    stripe_2: { cycles: 1100, effectiveness: 0.76, efficiency: 0.71, cultural: 0.96 },
    stripe_3: { cycles: 1300, effectiveness: 0.78, efficiency: 0.73, cultural: 0.96 },
    stripe_4: { cycles: 1500, effectiveness: 0.80, efficiency: 0.75, cultural: 0.96 }
  },
  brown_belt: {
    stripe_0: { cycles: 1750, effectiveness: 0.82, efficiency: 0.77, cultural: 0.97 },
    stripe_1: { cycles: 2000, effectiveness: 0.84, efficiency: 0.79, cultural: 0.97 },
    stripe_2: { cycles: 2250, effectiveness: 0.86, efficiency: 0.81, cultural: 0.97 },
    stripe_3: { cycles: 2500, effectiveness: 0.88, efficiency: 0.83, cultural: 0.97 },
    stripe_4: { cycles: 2750, effectiveness: 0.90, efficiency: 0.85, cultural: 0.97 }
  },
  black_belt: {
    stripe_0: { cycles: 3000, effectiveness: 0.92, efficiency: 0.87, cultural: 0.98 },
    stripe_1: { cycles: 3500, effectiveness: 0.93, efficiency: 0.88, cultural: 0.98 },
    stripe_2: { cycles: 4000, effectiveness: 0.94, efficiency: 0.89, cultural: 0.98 },
    stripe_3: { cycles: 4500, effectiveness: 0.95, efficiency: 0.90, cultural: 0.99 },
    stripe_4: { cycles: 5000, effectiveness: 0.96, efficiency: 0.91, cultural: 0.99 }
  }
};
...
class BeltProgressionManager {
    ...
    async initializeBeltProgression(characterId) {
        ...
        try {
            ...
            const progressionId = await generateAokHexId('progression_id');
